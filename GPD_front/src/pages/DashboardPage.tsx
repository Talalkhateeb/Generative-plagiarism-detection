  ...
  if (isNewUser) return (
    <div className="space-y-8 animate-fade-in">
      ...
      <Card className="p-8 text-center border-primary/20 bg-primary/5 relative overflow-hidden">
        ...
        <h3 className="text-lg font-bold mb-2">Welcome to Veritas.AI</h3>
        <p className="text-sm text-muted-foreground max-w-md mx-auto mb-6">
          Veritas.AI helps you detect plagiarism in academic documents using AI.
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Here's your Veritas.AI overview</p>
      </div>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
